...
NATIVE_SYSTEM_PROMPT = (
    ...
    "- preserve the selected question topic (slot and intent)\n"
    "- ask at most one question; never introduce another question\n"
    "- never invent facts, numbers, models or prices\n"
